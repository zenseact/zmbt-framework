...
expr::signature::Unary<Keyword::Concat> Concat = {};
expr::signature::Unary<Keyword::Union> Union = {};
expr::signature::Unary<Keyword::Intersect> Intersect = {};
expr::signature::Unary<Keyword::Diff> Diff = {};
expr::signature::Unary<Keyword::Cartesian> Cartesian = {};
expr::signature::Unary<Keyword::Transp> Transp = {};
expr::signature::Unary<Keyword::Set> Set = {};
expr::signature::Unary<Keyword::List> List = {};
