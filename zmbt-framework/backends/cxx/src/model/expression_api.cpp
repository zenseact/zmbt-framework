...
expr::signature::Base<Keyword::Not> Not = {};
...
expr::signature::OneParam<Keyword::And> And = {};
expr::signature::OneParam<Keyword::Or> Or = {};
...
expr::signature::VariadicExpr<Keyword::None> None = {};
