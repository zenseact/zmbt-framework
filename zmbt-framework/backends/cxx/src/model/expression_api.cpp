...
dsl::SignatureUnary<::zmbt::dsl::Keyword::Bool> const Truthy = Bool;
dsl::SignatureUnary<::zmbt::dsl::Keyword::Not> const Not = {};
dsl::SignatureUnary<::zmbt::dsl::Keyword::Not> const Falsy = Not;
dsl::SignatureUnary<::zmbt::dsl::Keyword::Not> const Nil = Not;
...
dsl::SignatureBinary<::zmbt::dsl::Keyword::Concat> const Cat = Concat;
...
dsl::SignatureDecorate const Decorate = {};
dsl::SignatureDecorate const Cast = Decorate;
dsl::SignatureUndecorate const Undecorate = {};
dsl::SignatureUndecorate const Uncast = Undecorate;
...
dsl::SignatureOverload const Overload = {};
dsl::SignatureOverload const Op = Overload;
