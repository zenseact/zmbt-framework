...
template class ModelDefinition::T_PipeId<ModelDefinition::N_MaybeChannel>;
template class ModelDefinition::T_TerminatePipe<ModelDefinition::N_PipeId>;
...
template class ModelDefinition::T_Tag<ModelDefinition::N_Decor>;
template class ModelDefinition::T_Take<ModelDefinition::N_CnlTag>;
