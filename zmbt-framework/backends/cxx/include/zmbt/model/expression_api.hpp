...
static signature::Unary<Keyword::Concat> const Concat;

/// \brief Set union
static signature::Unary<Keyword::Union> const Union;

/// \brief Set intersection
static signature::Unary<Keyword::Intersect> const Intersect;

/// \brief Set difference
static signature::Unary<Keyword::Diff> const Diff;

/// \brief Cartesian product
static signature::Unary<Keyword::Cartesian> const Cartesian;
...
static signature::Unary<Keyword::Set> const Set;

/// \brief Envelop value in list (equivalent to repeat(1))
static signature::Unary<Keyword::List> const List;
