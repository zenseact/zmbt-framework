...
constexpr std::uint32_t attributes(Keyword const& k)
{
    ...
    case Keyword::Fold: return is_binary | is_hiord | is_lazy;
    case Keyword::Map: return is_binary | is_hiord | is_lazy;
    case Keyword::Filter: return is_binary | is_hiord | is_lazy;
    case Keyword::Count: return is_binary | is_hiord | is_lazy;
    case Keyword::Each: return is_binary | is_predicate | is_hiord | is_lazy;
    case Keyword::Sort: return is_binary | is_hiord | is_lazy;
    case Keyword::Find: return is_binary | is_hiord | is_lazy;
    case Keyword::FindPtr: return is_binary | is_hiord | is_lazy;
    case Keyword::FindIdx: return is_binary | is_hiord | is_lazy;
    case Keyword::Min: return is_binary | is_hiord | is_lazy;
    case Keyword::Max: return is_binary | is_hiord | is_lazy;
    case Keyword::Argmin: return is_binary | is_hiord | is_lazy;
    case Keyword::Argmax: return is_binary | is_hiord | is_lazy;
    case Keyword::Recur: return is_binary | is_hiord | is_lazy;
    case Keyword::Unfold: return is_binary | is_hiord | is_lazy;
    case Keyword::Op: return is_unary | is_hiord | is_overload | is_lazy;
    case Keyword::Bind: return is_binary | is_hiord | is_lazy;
    case Keyword::Link: return is_binary | is_hiord | is_lazy;
    case Keyword::Capture: return is_binary | is_hiord | is_lazy;
    case Keyword::Refer: return is_binary | is_hiord | is_lazy;
    case Keyword::Let: return is_binary | is_hiord | is_lazy;
    case Keyword::Any: return is_variadic | is_predicate | is_hiord | is_lazy;
    case Keyword::All: return is_variadic | is_predicate | is_hiord | is_lazy;
    case Keyword::Saturate: return is_variadic | is_predicate | is_hiord | is_lazy;
    case Keyword::Pipe: return is_variadic | is_hiord | is_pipe | is_lazy;
    case Keyword::Tuple: return is_variadic | is_hiord | is_lazy;
    case Keyword::Fork: return is_variadic | is_hiord | is_fork | is_lazy;
    case Keyword::Flip: return is_binary | is_hiord | is_lazy;
    case Keyword::Dbg: return is_binary | is_hiord | is_lazy;
    case Keyword::Eval: return is_binary | is_hiord | is_lazy;
    case Keyword::Try: return is_binary | is_hiord | is_lazy;
    case Keyword::Kwrd: return is_unary | is_hiord | is_lazy;
    case Keyword::Prms: return is_unary | is_hiord | is_lazy;
    case Keyword::Q: return is_binary | is_autogen | is_quote;
    case Keyword::D: return is_binary | is_autogen | is_lazy;
