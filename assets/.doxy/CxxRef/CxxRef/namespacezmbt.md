...
| namespace | [**appconfig**](namespacezmbt_1_1appconfig.md) <br>_Test application configuration (work in progress)_  |
...
| class | [**TriggerIfc**](classzmbt_1_1TriggerIfc.md) <br>_Function wrapper. Transforms_ `(T...) -> R` _or_`(O*)(T...) -> R` _to_`(shared_ptr<void>, JSON) -> JSON` __ |
...
| struct | [**environment\_error**](structzmbt_1_1environment__error.md) <br>[_**Environment**_](classzmbt_1_1Environment.md) _operation error._ |
| struct | [**expression\_error**](structzmbt_1_1expression__error.md) <br>_Expression evaluation error._  |
| struct | [**expression\_not\_implemented**](structzmbt_1_1expression__not__implemented.md) <br>_Expression not implemented._  |
...
| struct | [**ifc\_args**](structzmbt_1_1ifc__args.md) &lt;class T&gt;<br> |
| struct | [**ifc\_handle**](structzmbt_1_1ifc__handle.md) &lt;class T&gt;<br> |
| struct | [**ifc\_host**](structzmbt_1_1ifc__host.md) &lt;class T, class&gt;<br> |
| struct | [**ifc\_pointer**](structzmbt_1_1ifc__pointer.md) &lt;class T&gt;<br> |
| struct | [**ifc\_return**](structzmbt_1_1ifc__return.md) &lt;class T&gt;<br> |
...
| Type | Name |
| ---: | :--- |
| enum  | [**ChannelKind**](#enum-channelkind)  <br> |
...
| typedef typename [**ifc\_args**](structzmbt_1_1ifc__args.md)&lt; T &gt;[**::type**](namespacezmbt.md#variable-type) | [**ifc\_args\_t**](#typedef-ifc_args_t)  <br> |
| typedef typename [**ifc\_handle**](structzmbt_1_1ifc__handle.md)&lt; T &gt;[**::type**](namespacezmbt.md#variable-type) | [**ifc\_handle\_t**](#typedef-ifc_handle_t)  <br> |
| typedef typename [**ifc\_host**](structzmbt_1_1ifc__host.md)&lt; T &gt;[**::type**](namespacezmbt.md#variable-type) | [**ifc\_host\_t**](#typedef-ifc_host_t)  <br> |
| typedef mp\_any&lt; ifc\_is\_fn\_ref&lt; T &gt;, ifc\_is\_fn\_ptr&lt; T &gt; &gt; | [**ifc\_is\_fn\_handle**](#typedef-ifc_is_fn_handle)  <br> |
| typedef mp\_all&lt; is\_pointer&lt; T &gt;, is\_function&lt; remove\_pointer\_t&lt; D &gt; &gt; &gt; | [**ifc\_is\_fn\_ptr**](#typedef-ifc_is_fn_ptr)  <br> |
| typedef mp\_all&lt; is\_lvalue\_reference&lt; T &gt;, is\_function&lt; remove\_pointer\_t&lt; D &gt; &gt; &gt; | [**ifc\_is\_fn\_ref**](#typedef-ifc_is_fn_ref)  <br> |
| typedef mp\_any&lt; ifc\_is\_functor\_ptr&lt; T &gt;, ifc\_is\_functor\_ref&lt; T &gt; &gt; | [**ifc\_is\_functor\_handle**](#typedef-ifc_is_functor_handle)  <br> |
| typedef mp\_all&lt; is\_pointer&lt; P &gt;, is\_class&lt; D &gt;, detail::support\_calltraits\_function&lt; D &gt; &gt; | [**ifc\_is\_functor\_ptr**](#typedef-ifc_is_functor_ptr)  <br> |
| typedef mp\_all&lt; is\_reference&lt; T &gt;, is\_class&lt; D &gt;, detail::support\_calltraits\_function&lt; D &gt; &gt; | [**ifc\_is\_functor\_ref**](#typedef-ifc_is_functor_ref)  <br> |
| typedef is\_member\_pointer&lt; D &gt; | [**ifc\_is\_member\_handle**](#typedef-ifc_is_member_handle)  <br> |
| typedef is\_member\_object\_pointer&lt; D &gt; | [**ifc\_is\_pmd\_handle**](#typedef-ifc_is_pmd_handle)  <br> |
| typedef is\_member\_function\_pointer&lt; D &gt; | [**ifc\_is\_pmf\_handle**](#typedef-ifc_is_pmf_handle)  <br> |
| typedef typename [**ifc\_pointer**](structzmbt_1_1ifc__pointer.md)&lt; T &gt;[**::type**](namespacezmbt.md#variable-type) | [**ifc\_pointer\_t**](#typedef-ifc_pointer_t)  <br> |
| typedef typename [**ifc\_return**](structzmbt_1_1ifc__return.md)&lt; T &gt;[**::type**](namespacezmbt.md#variable-type) | [**ifc\_return\_t**](#typedef-ifc_return_t)  <br> |
...
| typedef mp\_any&lt; ifc\_is\_pmf\_handle&lt; T &gt;, ifc\_is\_pmd\_handle&lt; T &gt;, ifc\_is\_fn\_handle&lt; T &gt;, ifc\_is\_functor\_handle&lt; T &gt; &gt; | [**is\_ifc\_handle**](#typedef-is_ifc_handle)  <br> |
...
| Type | Name |
| ---: | :--- |
|  constexpr add\_pointer\_t&lt; remove\_reference\_t&lt; ifc\_host\_t&lt; T &gt; &gt; &gt; | [**ifc\_host\_nullptr**](#variable-ifc_host_nullptr)   = `{}`<br>_Resolves to H\*{} for member function pointers of H, or to nullptr\_t for other callables._  |
...
|  [**Environment::TypedInterfaceHandle**](classzmbt_1_1Environment_1_1TypedInterfaceHandle.md)&lt; I &gt; | [**InterfaceRecord**](#function-interfacerecord) (I const & interface, [**object\_id**](classzmbt_1_1object__id.md) const & obj={[**ifc\_host\_nullptr**](namespacezmbt.md#variable-ifc_host_nullptr)&lt; I &gt;}) <br>_Make TypedInterfaceHandle instance._  |
...
|  auto | [**get\_ifc\_handle**](#function-get_ifc_handle) (T const x) <br>_Get reference to callable object._  |
|  auto | [**get\_ifc\_handle**](#function-get_ifc_handle) (T \* x) <br> |
|  auto | [**get\_ifc\_handle**](#function-get_ifc_handle) (T & x) <br> |
|  auto | [**get\_ifc\_pointer**](#function-get_ifc_pointer) (T x) <br>_Get pointer to callable object._  |
|  auto | [**get\_ifc\_pointer**](#function-get_ifc_pointer) (T \* x) <br> |
|  auto | [**get\_ifc\_pointer**](#function-get_ifc_pointer) (T & x) <br> |
...
|  js\_array\_slice\_gen | [**make\_slice\_generator**](#function-make_slice_generator) (boost::json::array & src, std::int64\_t const start, std::int64\_t const stop=-1, std::int64\_t const step=1) <br> |
...
|  boost::json::array | [**slice**](#function-slice) (boost::json::array const & src, boost::json::string\_view jp, std::int64\_t const start, std::int64\_t const stop=-1, std::int64\_t const step=1) <br>_Slice array with inclusive boundaries and subsignal cherry-pick._  |
|  boost::json::array | [**slice**](#function-slice) (boost::json::array const & src, std::int64\_t const start, std::int64\_t const stop=-1, std::int64\_t const step=1) <br>_Slice array with inclusive boundaries._  |
