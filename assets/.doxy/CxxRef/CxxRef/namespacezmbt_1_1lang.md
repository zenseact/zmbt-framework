...
| Type | Name |
| ---: | :--- |
|   | [**BOOST\_DESCRIBE\_STRUCT**](#function-boost_describe_struct) ([**Encoding**](structzmbt_1_1lang_1_1Encoding.md), (void), (keywords, depth, data, bindings)) <br> |
...
### function BOOST\_DESCRIBE\_STRUCT 

```C++
zmbt::lang::BOOST_DESCRIBE_STRUCT (
    Encoding,
    (void),
    (keywords, depth, data, bindings)
) 
```
