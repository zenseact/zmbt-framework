...
| Type | Name |
| ---: | :--- |
|  [**Expression**](classzmbt_1_1lang_1_1Expression.md) | [**operator()**](#function-operator()-12) (boost::json::string\_view const param) const<br>_Make parametrized expression._  |
|  [**Expression**](classzmbt_1_1lang_1_1Expression.md) | [**operator()**](#function-operator()-22) (std::size\_t const param) const<br>_Make parametrized expression._  |
