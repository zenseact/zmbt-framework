...
|  Target | [**ExpectBatch**](#function-expectbatch-12) ([**lang::Expression**](classzmbt_1_1lang_1_1Expression.md) const & expr) <br> |
|  Target | [**ExpectBatch**](#function-expectbatch-22) () <br> |
|  Target | [**ExpectOne**](#function-expectone-12) ([**lang::Expression**](classzmbt_1_1lang_1_1Expression.md) const & expr) <br> |
|  Target | [**ExpectOne**](#function-expectone-22) () <br> |
...
```C++
inline Target T_TerminatePipe::ExpectBatch (
    lang::Expression const & expr
) 
```
...
```C++
inline Target T_TerminatePipe::ExpectOne (
    lang::Expression const & expr
) 
```
