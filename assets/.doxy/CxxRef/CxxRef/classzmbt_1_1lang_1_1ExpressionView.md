...
|   | [**ExpressionView**](#function-expressionview-45) (EncodingView v) <br> |
...
|  EncodingView | [**encoding\_view**](#function-encoding_view) () const<br> |
...
|  bool | [**is\_capture**](#function-is_capture) () const<br> |
...
| Type | Name |
| ---: | :--- |
|  EncodingView | [**encoding\_view\_**](#variable-encoding_view_)  <br> |
...
### function is\_capture 

```C++
inline bool zmbt::lang::ExpressionView::is_capture () const
```
