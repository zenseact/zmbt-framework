...
| typedef typename [**reflect::invocation**](structzmbt_1_1reflect_1_1invocation.md)&lt; I &gt;[**::type**](namespacezmbt.md#variable-type) | [**interface\_t**](#typedef-interface_t)  <br> |
| typedef typename [**invocation**](structzmbt_1_1reflect_1_1invocation.md)&lt; T &gt;::args\_t | [**invocation\_args\_t**](#typedef-invocation_args_t)  <br>_Interface arguments tuple type._  |
| typedef tuple\_unqf\_t&lt; [**invocation\_args\_t**](namespacezmbt_1_1reflect.md#typedef-invocation_args_t)&lt; T &gt; &gt; | [**invocation\_args\_unqf\_t**](#typedef-invocation_args_unqf_t)  <br>_Interface cv-unqualified arguments tuple type._  |
| typedef std::integral\_constant&lt; bool, 0==boost::mp11::mp\_size&lt; [**invocation\_args\_t**](namespacezmbt_1_1reflect.md#typedef-invocation_args_t)&lt; T &gt; &gt;::value &gt; | [**invocation\_has\_void\_args**](#typedef-invocation_has_void_args)  <br>_Interface has no args._  |
| typedef std::is\_void&lt; [**invocation\_ret\_t**](namespacezmbt_1_1reflect.md#typedef-invocation_ret_t)&lt; T &gt; &gt; | [**invocation\_has\_void\_ret**](#typedef-invocation_has_void_ret)  <br>_Interface has no return._  |
...
| typedef typename [**invocation**](structzmbt_1_1reflect_1_1invocation.md)&lt; T &gt;::return\_t | [**invocation\_ret\_t**](#typedef-invocation_ret_t)  <br>_Interface return type._  |
...
| typedef remove\_cvref\_t&lt; [**invocation\_ret\_t**](namespacezmbt_1_1reflect.md#typedef-invocation_ret_t)&lt; T &gt; &gt; | [**invocation\_unqf\_ret\_t**](#typedef-invocation_unqf_ret_t)  <br>_Interface cv-unqualified return type._  |
...
|  boost::json::object | [**prototypes**](#function-prototypes) () <br>_Interface prototypes in JSON as {"args": [...], "return": ... }._  |
...
### typedef invocation\_unqf\_ret\_t 
