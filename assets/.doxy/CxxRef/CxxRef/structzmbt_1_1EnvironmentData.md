...
| typedef std::map&lt; boost::json::string, std::pair&lt; Generator::Shared, [**lang::Expression**](classzmbt_1_1lang_1_1Expression.md) &gt; &gt; | [**GeneratorsTable**](#typedef-generatorstable)  <br> |
...
|  std::map&lt; [**object\_id**](classzmbt_1_1object__id.md), std::map&lt; [**interface\_id**](classzmbt_1_1interface__id.md), std::map&lt; ChannelKind, GeneratorsTable &gt; &gt; &gt; | [**input\_generators**](#variable-input_generators)  <br> |
...
### typedef GeneratorsTable 

```C++
using zmbt::EnvironmentData::GeneratorsTable =  std::map<boost::json::string, std::pair<Generator::Shared, lang::Expression> >;
```
...
```C++
std::map<object_id, std::map<interface_id, std::map<ChannelKind, GeneratorsTable> > > zmbt::EnvironmentData::input_generators;
```
