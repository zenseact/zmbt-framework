...
| Type | Name |
| ---: | :--- |
|  boost::json::array | [**CaptureSlice**](#function-captureslice) (boost::json::string\_view signal\_path, int start=0, int stop=-1, int const step=1) const<br> |
...
|  boost::json::array | [**ObservedArgs**](#function-observedargs) (int const nofcall=-1) <br>_Input arguments observed at nofcall._  |
|  std::size\_t | [**ObservedCalls**](#function-observedcalls) () const<br>_Number of interface calls._  |
|  boost::json::value | [**ObservedReturn**](#function-observedreturn) (int const nofcall=-1) const<br>_Observed return value at nofcall._  |
|  boost::json::value const & | [**PrototypeArgs**](#function-prototypeargs) () const<br> |
|  boost::json::value const & | [**PrototypeReturn**](#function-prototypereturn) () const<br> |
|  [**InterfaceHandle**](classzmbt_1_1Environment_1_1InterfaceHandle.md) & | [**RunAsAction**](#function-runasaction) () <br> |
|  [**InterfaceHandle**](classzmbt_1_1Environment_1_1InterfaceHandle.md) & | [**RunAsTrigger**](#function-runastrigger) (std::size\_t const nofcall=0) <br> |
...
| Type | Name |
| ---: | :--- |
|  [**JsonNode**](classzmbt_1_1JsonNode.md) | [**captures**](#variable-captures)  <br> |
...
_Input arguments observed at nofcall._ 
```C++
...
_Observed return value at nofcall._ 
```C++
