...
| Type | Name |
| ---: | :--- |
|  require\_not\_str&lt; C, Target &gt; | [**At**](#function-at-14) (C && cal, [**object\_id**](classzmbt_1_1object__id.md) const & obj) <br>_Create input channel with an interface literal._  |
|  require\_not\_str&lt; C, Target &gt; | [**At**](#function-at-24) (C && cal, [**Param**](classzmbt_1_1Param.md) const & obj) <br> |
|  require\_not\_str&lt; C, Target &gt; | [**At**](#function-at-34) (C && cal) <br>_Create input channel._  |
...
```C++
template<class C>
inline require_not_str< C, Target > T_At::At (
    C && cal,
    object_id const & obj
) 
```
