...
* **namespace** [**zmbt**](namespacezmbt.md) _ZMBT root namespace._     
    * **class** [**Environment**](classzmbt_1_1Environment.md) _Controlled environment data storage._     
        ...
        * **struct** [**PersistentConfig**](structzmbt_1_1Environment_1_1PersistentConfig.md)     
    ...
    * **class** [**TriggerIfc**](classzmbt_1_1TriggerIfc.md) _Function wrapper. Transforms_ `(T...) -> R` _or_`(O*)(T...) -> R` _to_`(shared_ptr<void>, JSON) -> JSON` __    
    ...
    * **namespace** [**appconfig**](namespacezmbt_1_1appconfig.md) _Test application configuration (work in progress)_ 
    ...
    * **struct** [**environment\_error**](structzmbt_1_1environment__error.md) [_**Environment**_](classzmbt_1_1Environment.md) _operation error._    
    * **namespace** [**expr**](namespacezmbt_1_1expr.md) _Expression Language API._     
    * **struct** [**expression\_error**](structzmbt_1_1expression__error.md) _Expression evaluation error._     
    * **struct** [**expression\_not\_implemented**](structzmbt_1_1expression__not__implemented.md) _Expression not implemented._ 
    ...
    * **namespace** [**lang**](namespacezmbt_1_1lang.md) [_**Expression**_](classzmbt_1_1lang_1_1Expression.md) _Language implementation._    
        * **class** [**Expression**](classzmbt_1_1lang_1_1Expression.md)     
            * **struct** [**EvalContext**](structzmbt_1_1lang_1_1Expression_1_1EvalContext.md) [_**Expression**_](classzmbt_1_1lang_1_1Expression.md) _evaluation context._    
            * **struct** [**EvalLog**](structzmbt_1_1lang_1_1Expression_1_1EvalLog.md) [_**Expression**_](classzmbt_1_1lang_1_1Expression.md) _evaluation log._    
        ...
        * **struct** [**SignatureDebug**](structzmbt_1_1lang_1_1SignatureDebug.md)     
        * **struct** [**SignatureDecorate**](structzmbt_1_1lang_1_1SignatureDecorate.md)     
        * **struct** [**SignatureError**](structzmbt_1_1lang_1_1SignatureError.md)     
        * **struct** [**SignatureOverload**](structzmbt_1_1lang_1_1SignatureOverload.md)     
        * **struct** [**SignatureTernary**](structzmbt_1_1lang_1_1SignatureTernary.md) _Ternary expression._     
        * **struct** [**SignatureUnary**](structzmbt_1_1lang_1_1SignatureUnary.md) _Unary expression._ 
        * **struct** [**SignatureUndecorate**](structzmbt_1_1lang_1_1SignatureUndecorate.md)     
        * **struct** [**SignatureVariadic**](structzmbt_1_1lang_1_1SignatureVariadic.md) _Variadic expression._     
    * **namespace** [**logging**](namespacezmbt_1_1logging.md) _Logging (work in progress)_     
    * **namespace** [**mapping**](namespacezmbt_1_1mapping.md) _Signal Mapping model functionality._     
        ...
        * **class** [**PipeHandle**](classzmbt_1_1mapping_1_1PipeHandle.md)     
...
* **struct** [**internal\_tag**](structzmbt_1_1lang_1_1Expression_1_1internal__tag.md) 
